...
| Field | Value |
| --- | --- |
| **Name** | `sprint-roll-skill` |
| **Description** | AI agent skill: sprint-roll |
| **Category** | general |
| **Version** | `0.1.0` |
| **Author** | Community |
| **License** | MIT |
...
cp -r sprint-roll ~/.hermes/skills/sprint-roll/

# Option B: Install directly from this repository's raw SKILL.md URL
<agent-cli> skills install https://raw.githubusercontent.com/iizcm/sprint-roll-skill/main/SKILL.md

# Option C: Clone this entire repo into your skills directory
git clone https://github.com/iizcm/sprint-roll-skill.git ~/.hermes/skills/sprint-roll/
```
...
```text
Use the sprint roll skill to <describe your specific task here>
```
...
```text
Gunakan skill sprint roll untuk <deskripsikan tugas spesifik Anda di sini>
```
